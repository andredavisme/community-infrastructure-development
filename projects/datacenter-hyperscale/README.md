...
Scenario slug: `datacenter-hyperscale`

Large-scale hyperscale data center (~200 ac). See [comparison.html](../../docs/community-presentation/comparison.html) for benchmarks.
