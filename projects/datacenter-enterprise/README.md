...
Scenario slug: `datacenter-enterprise`

Mid-scale enterprise data center (~30 ac). See [comparison.html](../../docs/community-presentation/comparison.html) for benchmarks.
